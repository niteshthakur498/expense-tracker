...
public class ExpenseEventController {
    ...
    public ResponseEntity<ResponseWrapper<ExpenseEventResponseDTO>> createExpenseEvent(@PathVariable Long userId,
        ...
        ResponseWrapper<ExpenseEventResponseDTO> response = new ResponseWrapper<>(HttpStatus.OK.value(), "Successfully Retrieved", expenseEventResponseDTO, new ArrayList<>());
    ...
    public ResponseEntity<ResponseWrapper<List<ExpenseEventResponseDTO>>> findAllUserEvents(@PathVariable Long userId) {
        ...
        ResponseWrapper<List<ExpenseEventResponseDTO>> response = new ResponseWrapper<>(HttpStatus.OK.value(), "Successfully Retrieved", expenseEvents, new ArrayList<>());
        return ResponseEntity.status(HttpStatus.OK)
                .body(response);
    }
    ...
    public ResponseEntity<ResponseWrapper<String>> deleteExpenseEvent(@PathVariable Long userId,
        ...
        ResponseWrapper<String> response = new ResponseWrapper<>(HttpStatus.OK.value(), "Successfully Deleted", null, new ArrayList<>());
        return ResponseEntity.status(HttpStatus.OK)
                .body(response);
    }
